...
_internal Pn E_gui_Q_pointer_S_screen_buffer;
...
_private volatile B E_gui_S_mouse_drawing_hold;
//==============================================================================
_private
N
E_gui_T_print_u(
...
, N32 *font_i
    ...
    *font_i = i;
    dx *= E_gui_Q_taskbar_S_thickness;
...
E_gui_M( void
    ...
    E_gui_Q_pointer_S_screen_buffer = Mt( sizeof(N32), E_gui_Q_pointer_S_width * E_gui_Q_pointer_S_height );
    if( !E_gui_Q_pointer_S_screen_buffer )
        return ~0;
    ...
    E_vga_R_rect( E_gui_Q_pointer_S_screen_buffer
    , E_gui_Q_pointer_S_screen_buffer_coordinate[0], E_gui_Q_pointer_S_screen_buffer_coordinate[1]
    ...
    N8 window_i = E_windows_Q_window_M( E_window_Q_desktop_S_current, "System log", "", E_window_log_I_draw );
    if( (S8)window_i < 0 )
        return (S8)window_i;
...
, N32 y
){  E_vga_I_draw_x_line( x, y, E_gui_Q_pointer_S_width, 0 );
    E_vga_I_draw_y_line( x, y + 1, E_gui_Q_pointer_S_height - 1, 0 );
}
_internal
void
E_gui_Q_pointer_I_move_( void
...
){  E_vga_P_rect( E_gui_Q_pointer_S_screen_buffer
    , E_gui_Q_pointer_S_screen_buffer_coordinate[0], E_gui_Q_pointer_S_screen_buffer_coordinate[1]
    , E_gui_Q_pointer_S_width, E_gui_Q_pointer_S_height
    );
    E_gui_Q_pointer_I_move_();
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
_internal
void
...
){  N32 height = E_gui_Q_taskbar_S_font_size + 1 + 2 * (( E_gui_Q_taskbar_S_font_size + 1 ) * E_font_S_font.height + E_gui_Q_taskbar_S_font_size + 1 );
        ...
        {   N32 x = i * width + E_gui_Q_taskbar_S_thickness + 1;
            ...
            {   U u = ~0;
                ...
                if( !E_gui_T_print_u( x, width, E_gui_Q_taskbar_S_thickness, &u, &font_i ))
                    break;
                E_font_I_draw_u( font_i
                , x, E_gui_Q_taskbar_S_font_size + 1 + ( E_gui_Q_taskbar_S_font_size + 1 ) * E_font_S_font.height + E_gui_Q_taskbar_S_font_size + 1
                , E_gui_Q_taskbar_S_font_size + 1 + ( E_gui_Q_taskbar_S_font_size + 1 ) * E_font_S_font.height + E_gui_Q_taskbar_S_font_size + 1, ( E_gui_Q_taskbar_S_font_size + 1 ) * E_font_S_font.height
                , E_vga_S_text_color
                , E_gui_Q_taskbar_S_font_size, E_gui_Q_taskbar_S_thickness
                );
                x += ( E_gui_Q_taskbar_S_thickness + 1 ) * E_font_S_font.bitmap[ font_i ].width + E_gui_Q_taskbar_S_thickness + 1;
